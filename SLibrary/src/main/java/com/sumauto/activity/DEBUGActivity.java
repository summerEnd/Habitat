...
public class DEBUGActivity extends FragmentActivity implements ViewPager.OnPageChangeListener, ViewPager.PageTransformer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logList = (LinkedList<ExceptionHandler.ErrorLog>) CacheManager.getInstance().read(CacheManager.ERROR_LOGS);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.slib_share) {
            //发送日志
            ExceptionHandler.ErrorLog errorLog = logList.get(curPageIndex);
    ...
    class MyAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            ExceptionHandler.ErrorLog error = logList.get(position);
