...
public class PageStrip extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        indicatorHeight = a.getDimensionPixelOffset(R.styleable.ITab_indicateHeight, 3);
     ...
     * will be set for this ViewPager.so,don't call the {@link ViewPager#setOnPageChangeListener(ViewPager.OnPageChangeListener) ViewPager.setOnPageChangeListener}
     * for this ViewPager .call {@link PageStrip#setPageChangeListener(ViewPager.OnPageChangeListener) PageStrip.setOnPageChangeListener}
     * instead </p>
     *
    ...
    public void addTab(ITab tab) {
        ...
        if (tabView.getLayoutParams() == null || !(tabView.getLayoutParams() instanceof LayoutParams)) {
